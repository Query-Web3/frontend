    ...
    <div class="tokens gradient-body">
        <div class="container section-first">
            <div class="flex items-center staking-box !m-0">
                ...
                <form class="query-box flex-1 px-4">
                    <div class="query-item flex items-center bg-white pl-2 outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600 dark:bg-white/5 dark:outline-gray-600 dark:has-[input:focus-within]:outline-indigo-500">
        ...
        <div class="container">
            <div class="flex staking-box bg-transparent items-center">
                <div class="icon flex items-center"></div>
            ...
            <div class="flex staking-box items-center" v-for="(economic, _) in economicsData">
                ...
                <div class="mstaking min-w-[140px] flex-1 flex justify-center items-center">
                    {{ showToken(getStaking(economic.id, stakingsData), economic.metadata.decimals) }}<span
                        class="text-split">/</span>{{
                ...
                <div class="daily min-w-[150px] flex-1 flex justify-center items-center">
                    {{ showWTE(getStakingReward(economic, stakingsData, blockRewardData, totalData[economic.id])) }}
                    <span class="unit">WTE</span>
                </div>
...
const economicsData = ref<any[]>([
    // { "id": "0", "metadata": { "name": "TOKEN", "symbol": "Chain mint", "decimals": 12, "total": "-", "staking_symbol": "", "action": "Chain Mint" }, "v": "10" },
]);
